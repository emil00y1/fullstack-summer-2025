...
describe('PostItem Component', () => {
  ...
  it('shows dropdown menu for own posts', () => {
    ...
    // Should show the more options button for own posts
    expect(screen.getByRole('button', { name: '' })).toBeInTheDocument(); // MoreVertical button
  });
  ...
  it('navigates to post page when clicking comment button', () => {
    ...
    const commentButton = screen.getByRole('button', { name: /2/i }); // Comments count button
