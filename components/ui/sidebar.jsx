...
const SIDEBAR_WIDTH_MOBILE = "16rem"; // Same as desktop for consistency
...
function SidebarProvider({
  ...
  // State for data-state="expanded" or "collapsed"
...
function Sidebar({
  ...
  // Render sidebar consistently for both mobile and desktop
  return (
    <div
